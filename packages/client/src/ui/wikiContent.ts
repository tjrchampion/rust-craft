...
Open the **Crafting Tab** to access the 3x3 Crafting Grid. Drop ingredients in any slot to match these recipes:

### Minor Healing Potion
- **Description**: Instantly restores 40 Health.
- **Ingredients**: 3 Berries, 5 Wood.

### Runic Healing Potion
- **Description**: Instantly restores 100 Health.
- **Ingredients**: 10 Berries, 5 Ancient Dust.

### Minor Mana Potion
- **Description**: Instantly restores 40 Mana.
- **Ingredients**: 5 Ancient Dust.

### Runic Mana Potion
- **Description**: Instantly restores 100 Mana.
- **Ingredients**: 10 Ancient Dust, 5 Bones.

### Frontline Potion
- **Description**: Temporarily boosts Armor (+6) and Vitality (+4) for 20 seconds.
- **Ingredients**: 10 Stone, 2 Animal Hide.

### Potion of Focus
- **Description**: Temporarily boosts Power (+6) and Critical Strike (+15%) for 20 seconds.
- **Ingredients**: 5 Bones, 5 Ancient Dust.

### Invisibility Potion
- **Description**: Shrouds you from mob aggro scanning for 15 seconds.
- **Ingredients**: 5 Ancient Dust, 3 Animal Hide.

### Free Action Potion
- **Description**: Restores mobility, grants 15% speed, and grants slow immunity for 15 seconds.
- **Ingredients**: 8 Berries, 5 Animal Hide.

### Flask of the Titan
- **Description**: Flask that boosts Max HP by +60 for 30 minutes.
- **Ingredients**: 20 Stone, 10 Bones, 5 Ancient Dust.

### Phial of Quickness
- **Description**: Phial that boosts Movement Speed by +15% for 30 minutes.
- **Ingredients**: 15 Berries, 15 Animal Hide, 5 Ancient Dust.

### Basic Items
- **Stone Axe**: 30 Wood, 10 Stone.
- **Stone Pickaxe**: 25 Wood, 15 Stone.
- **Wooden Spear**: 35 Wood, 5 Stone.
- **Campfire**: 25 Wood, 10 Stone (required for cooking meat).
- **Cooked Meat**: 1 Raw Meat (cooked near Campfire).
- **Bandage**: 2 Animal Hide.

---

## Party Questing & Sharing

Adventuring in a party provides shared benefits to quest progression and access:
- **Quest Sharing**: If you are in a party, you can share active quests with nearby party members from your Quest Log. If they meet level requirements and are within **40 meters**, they will receive a prompt to accept.
- **Shared Progress**: When party members are within **40 meters** of each other, they share objective credit. Defeating target enemies or gathering target resources will grant progress to all nearby party members who have the quest active.
- **Accepting Shared Quests**: You can accept a shared quest directly from range as long as you are within **40 meters** of the sharing party member. Quest turn-ins must still be completed at the quest giver NPC in town.

---

## Gathering & World Entities

Harvest raw nodes in the wilderness:
- **Pine Trees**: Chop with Axe to gather **Wood**.
- **Stone Outcrops**: Mine with Pickaxe to gather **Stone**.
- **Berry Bushes**: Harvest by hand to gather **Berries**.
- **Wildlife (Stags, Wolves, Alpacas)**: Slain beasts yield **Raw Meat** and **Animal Hide**.
- **Undead (Skeletons)**: Defeated skeletons yield **Bones** and **Ancient Dust**.
`;
