...
export const AURAS: Record<string, AuraDef> = {
  ...
  battle_fury: {
    ...
    name: "Battle Fury",
    durationS: 6,
    statModifiers: { power: 4, moveSpeedMult: 0.15, critChance: 0.15, hasteRating: 40 },
    icon: "⚔️",
    positive: true,
  },
  recklessness: {
    ...
    name: "Recklessness",
    durationS: 8,
    statModifiers: { critChance: 0.25, power: 6, hasteRating: 60 },
    icon: "💢",
    positive: true,
  },
  steam_focus: {
    ...
    name: "Steam Focus",
    durationS: 10,
    statModifiers: { hasteRating: 80, hitRating: 40, power: 3 },
    icon: "⚙️",
    positive: true,
  },
  burning: {
  ...
  phial_quickness: {
    ...
    durationS: 1800,
    statModifiers: { moveSpeedMult: 0.15, hasteRating: 50 },
    icon: "💨",
    positive: true,
  },
};
